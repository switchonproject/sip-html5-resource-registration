...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        'target/dist/bower_components/angular/angular.min.js',
        'target/dist/bower_components/angular-animate/angular-animate.min.js',
        'target/dist/bower_components/angular-resource/angular-resource.min.js',
        ...
        'target/dist/bower_components/angular-leaflet-directive/dist/angular-leaflet-directive.min.js',
